...
<div class="container">
    <div class="row justify-content-center ">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Registrar novo usuário</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-0">
                            {{-- DIV ABAIXO, POSICIONA O Voltar A ESQUERDA DO Registrar COM: d-flex justify-content-between align-items-center --}}
